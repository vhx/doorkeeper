  ...
  context 'with PKCE' do
    context 'plain' do
      ...
      scenario 'mobile app requests an access token with authorization code and plain code challenge method' do
        ...
        driver_should_have_json 'token_type', 'bearer'
        driver_should_have_json_within 'expires_in', Doorkeeper::AccessToken.first.expires_in, 1
      end
    ...
    context 's256' do
      ...
      scenario 'mobile app requests an access token with authorization code and without code_verifier' do
        ...
        driver_should_have_json 'error', 'invalid_request'
        driver_should_not_have_json 'access_token'
      end
      ...
      scenario 'code_challenge_method in token request is totally ignored' do
        visit authorization_endpoint_url(client: @client, code_challenge: code_challenge, code_challenge_method: 'S256')
        click_on 'Authorize'
